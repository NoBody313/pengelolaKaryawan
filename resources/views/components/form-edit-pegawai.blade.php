            ...
            <div class="form-container">
                ...
                <div class="input-layout">
                    ...
                    <input name="tanggal_masuk" class="input-field-form" id="input-nama" type="date"
                        value="{{ optional($pegawaiData)->tanggal_masuk }}">
                </div>
            </div>
            <div class="form-container">
                <div class="input-layout">
            ...
            <div class="flex flex-col justify-center items-center gap-4 w-full">
                ...
                <div class="form-container">
                    ...
                    <div class="input-layout">
                        <label class="input-label" for="input-kodePos">Kode
                            Pos</label>
                        <input name="kodepos_domisili" class="input-field-form" id="input-kodePosDomisili" type="number"
                            inputmode="numeric"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
            ...
            <div class="form-container">
                <div class="input-layout">
                    ...
                    <input name="no_hp_tsel" class="input-field-form" id="input-nomorTsel" type="tel"
                        inputmode="numeric"
                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        value="{{ optional($pegawaiData)->no_hp_tsel }}" min="10" maxlength="15" pattern="[0-9]{10,14}">
