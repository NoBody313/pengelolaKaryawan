...
@section('form')
    <form id="updateForm" action="{{ route('post-pegawai-edit-alamat-ktp', ['nik_admedika' => $data->nik_admedika]) }}"
                    ...
                    <div class="form-container-alamat">
                        <div class="input-layout-alamat">
                            <label class="input-label" for="input-alamatKTP">Alamat
                                Lengkap</label>
                            <input name="alamat_ktp" class="input-field-form-alamat" id="input-alamatKTP" type="text"
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="provinsi_ktp" id="selectProvKTP" class="input-field-form-alamat">
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kab_kota_ktp" class="input-field-form-alamat" id="select-kabKota-ktp">
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kec_ktp" class="input-field-form-alamat" id="selectKecKTP">
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kel_ktp" class="input-field-form-alamat" id="selectKelKTP">
                        ...
                        <div class="input-layout-alamat">
                            <label class="input-label" for="input-kodePos">Kode
                                Pos</label>
                            <input name="kodepos_ktp" class="input-field-form-alamat" id="input-kodePos" type="number"
