...
@section('form')
    <form id="updateForm" action="{{ route('post-pegawai-edit-status', ['nik_admedika' => $data->nik_admedika]) }}"
                    ...
                    <div class="form-container">
                        <div class="input-layout">
                            ...
                            <select name="pendidikan_terakhir" class="input-field-form" id="input-pendidikan" required>
                                <option disabled selected>{{ $data->pendidikan_terakhir }}
                                </option>
                ...
                <div class="flex flex-col items-center justify-center w-full gap-4">
                    ...
                    <div class="form-container">
                        <div class="input-layout">
                            ...
                            <select name="status_pernikahan" required class="input-field-form"
                                id="input-statusPernikahan">
                                <option disabled selected>{{ $data->status_pernikahan }}
                                </option>
                        ...
                        <div class="input-layout">
                            ...
                            <input name="tanggal_pernikahan" class="input-field-form" id="input-tgl-menikah"
                                type="date" value="{{ optional($data)->tanggal_pernikahan }}">
                            @include('components.required-kol')
                        </div>
                    </div>
                    <div class="form-container">
