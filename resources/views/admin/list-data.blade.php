            ...
            <div class="flex flex-col lg:flex-row justify-between w-full py-4">
                ...
                <div class="flex flex-col lg:flex-row justify-center items-center gap-2">
                    <form action="{{ route('import_excel', ['nik_admedika' => $data->nik_admedika]) }}" method="post"
                        ...
                        <button type="submit"
                            class="inline-flex w-full lg:w-44 justify-center items-center bg-blue-600 text-white rounded-md mt-2 lg:mt-0 p-4 lg:p-3">Import
                            Excel</button>
                    </form>
                        ...
                        <tr class="min-w-full h-full p-4">
                            ...
                            <td class="flex flex-col lg:flex-row mx-auto justify-center items-center gap-1">
                                ...
                                <a href="#" onclick="openConfirmationModal('{{ $pegawaiData->nik_admedika }}')"
                                    class="p-2 px-5 text-center bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 m-2 rounded-md cursor-pointer">Hapus</a>
                                <!-- Modal -->
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <a onclick="closeConfirmationModal({{ $pegawaiData->nik_admedika }})"
                                                    class="w-1/2 inline-flex justify-center rounded-md px-5 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:text-sm">
                                                    Batal
                                                </a>
                                                <a href="{{ route('delete-data-karyawan', ['nik_admedika' => $data->nik_admedika, 'id' => $pegawaiData->id]) }}"
                                                    class="w-1/2 p-2 text-center bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 m-2 rounded-md cursor-pointer"
