                    ...
                    <div class="form-container-alamat">
                        <div class="input-layout-alamat">
                            <label class="input-label" for="input-alamatKTP">Alamat
                                Lengkap</label>
                            <textarea name="alamat_ktp" class="input-field-form-alamat" id="input-alamatKTP" type="text" rows="3" required>{{ $pegawaiData->alamat_ktp }}</textarea>
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kab_kota_ktp" class="input-field-form-alamat" id="input-kabKota-ktp">
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kec_ktp" class="input-field-form-alamat" id="input-kecamatan-ktp">
                        ...
                        <div class="input-layout-alamat">
                            ...
                            <select name="kel_ktp" class="input-field-form-alamat" id="input-kelurahan-ktp">
