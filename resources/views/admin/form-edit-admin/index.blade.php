...
<body>
    <nav class="flex flex-col items-center justify-center m-8 md:flex-row">
        ...
        @php
            $steps = [
                ['label' => 'Data Pribadi', 'number' => 1, 'route' => 'edit-data-pribadi'],
                ['label' => 'Alamat KTP', 'number' => 2, 'route' => 'edit-alamat-ktp'],
                ['label' => 'Alamat Domisili', 'number' => 3, 'route' => 'edit-alamat-domisili'],
                ['label' => 'Status Pendidikan & Pernikahan', 'number' => 4, 'route' => 'edit-status'],
                ['label' => 'Kontak', 'number' => 5, 'route' => 'edit-kontak'],
            ];
