        ...
        <div class="mt-5 sm:mt-8">
                    ...
                    <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="nik_admedika"
                                ...
                                id="nik_admedika" type="number" required inputmode="numeric"
                        ...
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="nik_tg"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-nikTg" type="number" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                    ...
                    <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="kota_lahir"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-kotaKelahiran" type="text" required placeholder="Masukkan kota kelahiran">
                        </div>
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            <label class="block text-sm font-medium mb-2" for="input-ttl">Tanggal Lahir</label>
                            <input name="tanggal_lahir"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-ttl" type="date" required placeholder="Masukkan tanggal lahir sesuai KTP">
                        </div>
                    </div>
                    <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="tahun_lahir"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-tahunLahir" type="number" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        ...
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="no_ktp"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-noKTP" type="number" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
            ...
            <div data-hs-stepper-content-item='{
                ...
                <div class="flex flex-col justify-center items-center px-8 gap-4 w-full">
                    <div class="flex flex-col justify-center items-center px-8 gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            <label class="block text-sm font-medium mb-2" for="input-alamatKTP">Alamat Lengkap</label>
                            <input name="alamat_ktp"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-alamatKTP" type="text" required
                        ...
                        <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="kab_kota_ktp"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kabKota" type="text" required
                                    placeholder="Masukkan Kab/Kota sesuai KTP">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                <label class="block text-sm font-medium mb-2" for="input-provinsi">Provinsi</label>
                                <input name="provinsi_ktp"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-provinsi" type="text" required
                                    placeholder="Masukkan provinsi sesuai KTP">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                <label class="block text-sm font-medium mb-2" for="input-kodePos">Kode Pos</label>
                                <input name="kodepos_ktp"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kodePos" type="number" required inputmode="numeric"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        ...
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="alamat_domisili"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-alamatLengkap" type="text" required
                        ...
                        <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="kab_kota_domisili"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kabKotaDomisili" type="text" required
                                    placeholder="Masukan kab/kota domisili">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                <label class="block text-sm font-medium mb-2"
                                ...
                                <input name="provinsi_domisili"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-provinsiDomsili" type="text" required
                                    placeholder="Masukan provinsi domisili">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="kodepos_domisili"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kodePosDomisili" type="number" required inputmode="numeric"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        ...
                        <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                            ...
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="tanggal_pernikahan"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-ttl" type="date" required
                            ...
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="jumlah_anak"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kotaKelahiran" type="number" required
                        ...
                        <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                            ...
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="jurusan_pendidikan_terakhir"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-jurusan" type="text" required
                                    placeholder="Masukan Jurusan Pendidikan Terakhir">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="nama_institusi"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-institusi" type="text" required
                        ...
                        <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                                ...
                                <input name="kota_institusi"
                                    class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                    id="input-kotaInstitusi" type="text" required
                                    placeholder="Masukan kota institusi">
                            </div>
                            <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
            ...
            <div data-hs-stepper-content-item='{
                ...
                <div class="flex flex-col justify-center items-center px-8 gap-4 w-full">
                    <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="email_pribadi"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-emailPribadi" type="email" required placeholder="Masukan Email pribadi">
                        </div>
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="no_hp_tsel"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-nomorTsel" type="tel" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                    ...
                    <div class="flex flex-row justify-center items-center self-stretch gap-4 w-full">
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="no_hp_nontsel"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-nama" type="tel" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        ...
                        <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                            ...
                            <input name="no_hp_emergency"
                                class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                id="input-nomorEmergency" type="tel" required inputmode="numeric"
                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                required placeholder="Masukan nomor Telkomsel" min="10" maxlength="15"
                                pattern="[0-9]{10,14}">
                        </div>
                    ...
                    <div class="flex flex-col justify-center items-start gap-2 self-stretch w-full">
                        ...
                        <input name="nama_ibu"
                            class="py-3 px-4 block w-full border-[1.5px] border-red-900 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                            id="input-ibuKandung" type="text" required placeholder="Masukan nama ibu kandung">
                    </div>
                </div>
            </div>
